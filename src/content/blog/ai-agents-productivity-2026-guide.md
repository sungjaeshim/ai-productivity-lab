...
tags: ["AI Agents", "Productivity", "Automation", "AI Tools"]
---
...
1. **Researcher** — finds trending topics and relevant data
2. **Writer** — creates first drafts based on research
3. **Editor** — reviews for accuracy, tone, and SEO
