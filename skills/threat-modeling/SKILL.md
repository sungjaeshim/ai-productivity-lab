...
description: Threat modeling for application/system design using STRIDE, attack trees, and mitigation planning. Use when performing app-level security design reviews.
---
